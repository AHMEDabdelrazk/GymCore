...
import CheckInKiosk from "./pages/checkin/CheckInKiosk";
import BillingAndWebhooks from "./pages/billing/BillingAndWebhooks";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Core Enterprise Dashboard Routes */}
        <Route
          path="/dashboard"
          element={
            <ProtectedRoute>
        ...
        {/* Existing Member & Plan Management Routes */}
        <Route
          path="/plans"
          element={
            <ProtectedRoute>
